...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(
    ({
        ...
        return (
            <input
                className={'mb-2 appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline form-control' + className}
                type={type}
                ref={ref}
                name={name}
