...
public class ProductGroupController extends AbstractController {
    ...
    @PostMapping("/save")
    public ResponseEntity<Void> add(@RequestBody ProductGroupSaveDto productGroupSaveDto) {
        return add(productGroupSaveDto, productGroupService);
    }

    @PutMapping("/update")
    public ResponseEntity<Void> edit(@RequestBody ProductGroupSaveDto productGroupSaveDto) {
